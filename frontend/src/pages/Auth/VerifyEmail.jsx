      ...
      <div className="w-full max-w-md p-8 bg-white shadow-2xl rounded-2xl border border-gray-100">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full py-3 bg-gradient-to-r from-green-500 to-customGreen text-white font-semibold rounded-full hover:from-green-600 hover:to-customGreen focus:outline-none focus:ring-2 focus:ring-e-ride-purple transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
