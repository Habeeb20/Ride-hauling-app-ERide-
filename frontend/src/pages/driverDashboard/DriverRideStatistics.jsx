...
const DriverRideStatistics = ({ isDarkTheme }) => {
  ...
  return (
    <div className="lg:col-span-2 space-y-6">
      ...
      {/* Driver Statistics */}
      <h2 className={`text-xl font-semibold ${isDarkTheme ? 'text-white' : 'text-gray-800'} mb-4 mt-8`}>Driver Statistics</h2>
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
        <div
          className={`p-6 rounded-xl shadow-md ${isDarkTheme ? 'bg-gray-900' : 'bg-white'}`}
          aria-label="Total Driver Amount and Rides"
        >
          <p className={`${isDarkTheme ? 'text-gray-300' : 'text-gray-600'} mb-2`}>Total Amount & Rides</p>
          <div className="flex items-center mb-4">
            ...
            <div>
              <p className={`text-2xl font-bold ${isDarkTheme ? 'text-white' : 'text-gray-800'}`}>
                ${driverStatsFormatted.totalAmount.toFixed(2)}
              </p>
              <p className={`text-xl ${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {driverStatsFormatted1.totalRides} Rides
              </p>
            </div>
          </div>
          <div className="flex space-x-4">
            <div>
              <p className={`${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {Math.round((driverStatsFormatted.totalAmount / driverMaxAmount) * 100)}%
              </p>
              <div className="mt-4 w-16 h-16">
                <Doughnut data={driverTotalAmountData} options={chartOptions} />
              </div>
            </div>
            <div>
              <p className={`${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {Math.round((driverStatsFormatted1.totalRides / driverMaxRides) * 100)}%
              </p>
              <div className="mt-4 w-16 h-16">
                <Doughnut data={driverTotalRidesData} options={chartOptions} />
              </div>
            </div>
          </div>
        </div>
        <div
          className={`p-6 rounded-xl shadow-md ${isDarkTheme ? 'bg-gray-900' : 'bg-white'}`}
          aria-label="Completed Driver Rides Amount"
        >
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <p className={`text-2xl font-bold ${isDarkTheme ? 'text-white' : 'text-gray-800'}`}>
                ${driverStatsFormatted.completedAmount.toFixed(2)}
              </p>
              <p className={`text-xl ${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {driverStatsFormatted1.completedRides} Rides
              </p>
            </div>
          </div>
          <div className="flex space-x-4">
            <div>
              <p className={`${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {Math.round((driverStatsFormatted.completedAmount / driverMaxAmount) * 100)}%
              </p>
              <div className="mt-4 w-16 h-16">
                <Doughnut data={driverCompletedAmountData} options={chartOptions} />
              </div>
            </div>
            <div>
              <p className={`${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {Math.round((driverStatsFormatted1.completedRides / driverMaxRides) * 100)}%
              </p>
              <div className="mt-4 w-16 h-16">
                <Doughnut data={driverCompletedRidesData} options={chartOptions} />
              </div>
            </div>
          </div>
        </div>
        <div
          className={`p-6 rounded-xl shadow-md ${isDarkTheme ? 'bg-gray-900' : 'bg-white'}`}
          aria-label="Pending Driver Rides Amount"
        >
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <p className={`text-2xl font-bold ${isDarkTheme ? 'text-white' : 'text-gray-800'}`}>
                ${driverStatsFormatted.pendingAmount.toFixed(2)}
              </p>
              <p className={`text-xl ${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {driverStatsFormatted1.pendingRides} Rides
              </p>
            </div>
          </div>
          <div className="flex space-x-4">
            <div>
              <p className={`${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {Math.round((driverStatsFormatted.pendingAmount / driverMaxAmount) * 100)}%
              </p>
              <div className="mt-4 w-16 h-16">
                <Doughnut data={driverPendingAmountData} options={chartOptions} />
              </div>
            </div>
            <div>
              <p className={`${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {Math.round((driverStatsFormatted1.pendingRides / driverMaxRides) * 100)}%
              </p>
              <div className="mt-4 w-16 h-16">
                <Doughnut data={driverPendingRidesData} options={chartOptions} />
              </div>
            </div>
          </div>
        </div>
        <div
          className={`p-6 rounded-xl shadow-md ${isDarkTheme ? 'bg-gray-900' : 'bg-white'}`}
          aria-label="Cancelled Driver Rides Amount"
        >
          ...
          <div className="flex items-center mb-4">
            ...
            <div>
              <p className={`text-2xl font-bold ${isDarkTheme ? 'text-white' : 'text-gray-800'}`}>
                ${driverStatsFormatted.cancelledAmount.toFixed(2)}
              </p>
              <p className={`text-xl ${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {driverStatsFormatted1.cancelledRides} Rides
              </p>
            </div>
          </div>
          <div className="flex space-x-4">
            <div>
              <p className={`${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {Math.round((driverStatsFormatted.cancelledAmount / driverMaxAmount) * 100)}%
              </p>
              <div className="mt-4 w-16 h-16">
                <Doughnut data={driverCancelledAmountData} options={chartOptions} />
              </div>
            </div>
            <div>
              <p className={`${isDarkTheme ? 'text-gray-300' : 'text-gray-600'}`}>
                {Math.round((driverStatsFormatted1.cancelledRides / driverMaxRides) * 100)}%
              </p>
              <div className="mt-4 w-16 h-16">
                <Doughnut data={driverCancelledRidesData} options={chartOptions} />
              </div>
            </div>
          </div>
        </div>
...
export default DriverRideStatistics;